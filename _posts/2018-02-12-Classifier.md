...
<img src = '/assets/img/Classifier/equation12.png' height = '25px'>

上面求得的就是cost function，要求它的最小值可以用梯度下降法，对l(θ)求微分，可得

<img src = '/assets/img/Classifier/equation12.png' height = '65px'>
...
KNN算法的优点：1. 思想简单，理论成熟，既可以用来做分类也可以用来做回归；2. 可用于非线性分类；3. 训练时间复杂度为O(n)；
